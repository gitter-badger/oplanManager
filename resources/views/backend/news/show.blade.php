      ...
      <div class="col-md-8">
        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
            ...
            <h3>{{ $new->title }} <small>vytvořeno/editováno: v {{ $new->created_at }}- ID: {{ $new->id }}</small></h3>
          ...
          <div class="box-footer">
            {!! Form::open(array('route' => array('news.destroy', $new->id), 'method' => 'delete', 'id' => 'delform')) !!}
            ...
            <a href="{{ route('news.edit', $new->id ) }}" class="btn btn-primary"><i class="fa fa-pencil"></i> Editovat</a>
